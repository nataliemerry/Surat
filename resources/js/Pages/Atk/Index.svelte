        ...
        <tbody class="divide-y divide-gray-100">
          {#each tabList as req (req.id)}
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-4 py-3 font-medium text-gray-800">{req.requester_name}</td>
              <td class="px-4 py-3 text-gray-600">{req.team ? req.team.name : '-'}</td>
              <td class="px-4 py-3 text-gray-600">{req.activity}</td>
              <td class="px-4 py-3">
                <div class="flex items-center justify-center gap-2">
                  <button on:click={() => openDetail(req)} class="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50"> Lihat Detail </button>
      ...
      <div class="flex-1 px-6 py-5 space-y-4 overflow-y-auto">
        <div class="px-4 py-3 space-y-1 text-base rounded-lg bg-gray-50">
          <div class="flex gap-2">
            ...
            <span class="font-medium text-gray-800">{detailRequest.requester_name}</span>
          </div>
          <div class="flex gap-2">
      ...
      <div class="flex-1 px-6 py-5 space-y-4 overflow-y-auto">
        <div class="px-4 py-3 space-y-1 text-sm rounded-lg bg-gray-50">
          <div class="flex gap-2">
            ...
            <span class="font-medium text-gray-800">{reviewRequest.requester_name}</span>
          </div>
          <div class="flex gap-2">
