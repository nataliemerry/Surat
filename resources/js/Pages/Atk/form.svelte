...
<script>
  ...
  const staffNames = [
    ...
    'Eko Hermawati Agustin Setiyaningrum, SST, M.E.',
    'Eko Indarmawan, A.Md.',
    'Etania Harum Yonanda, SST, M.Ec.Dev.',
    'Fardiana, S.P.',
    ...
    'Jadhi Kurniawan HS',
    'Joko Permono',
    'Joko Prasetiyo, SST, M.Si.',
    'Khairunnisa Dewi Maharani, S.Tr.Stat.',
    'Lucky Kurniati, SST',
    'Lutfiah Adela Arzie, SST',
    ...
    'Ratih Kusuma Dewi, SST, M.Si.',
    'Restu Asih Trianto, SST, M.M.',
    'Retno Puji Kartinindyah, A.Md.',
    'Rika Dwi Apriliyanti',
    'Rina Arifatul Khoridah, SST',
    'Sadjana Yoga Hidayat, S.Si.',
    'Septania Ayu Wardhani, SST',
    'Setyo Dwi Kuncoro',
    'Slamet Subagyo',
    'Sofa Nur Khamama, SST',
    'Suroso, S.E.',
    'Tri Murni Hati Khasanah, SST',
    "Verliya Gadis Rhoma'idah, SST",
    'Wahyu Herry Wibowo, SST, M.E.',
    'Yuli Cahyono, S.M.',
