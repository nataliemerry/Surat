...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
  <a use:inertia href="/surat/dinas/form" class="w-full">
    <div class="flex h-32 w-full cursor-pointer items-center justify-start rounded-xl border border-gray-200 bg-white p-4 transition duration-200 hover:border-indigo-500 hover:shadow-md sm:h-48 sm:flex-col sm:justify-center">
      ...
      <p class="text-left text-sm font-semibold text-gray-700 sm:text-center sm:text-base">Buat Surat Dinas</p>
    </div>
  </a>
  ...
  <a use:inertia href="/surat/dinas/upload" class="w-full">
    <div class="flex h-32 w-full cursor-pointer items-center justify-start rounded-xl border border-gray-200 bg-white p-4 transition duration-200 hover:border-indigo-500 hover:shadow-md sm:h-48 sm:flex-col sm:justify-center">
      ...
      <p class="text-left text-sm font-semibold text-gray-700 sm:text-center sm:text-base">Upload Dokumen Surat Dinas</p>
    </div>
  </a>
</div>
