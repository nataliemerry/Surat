    ...
    {#if isAdmin}
      <div class="group flex items-start py-2">
        <a use:inertia href="/atk/barang">
          <div class={isUrl('atk/barang') ? 'text-white' : 'text-indigo-300 group-hover:text-white'}>Kelola Barang</div>
        </a>
      </div>
      <div class="group flex items-start py-2">
        <a use:inertia href="/atk/rekap">
          <div class={isUrl('atk/rekap') ? 'text-white' : 'text-indigo-300 group-hover:text-white'}>Rekap Bulanan</div>
        </a>
      </div>
      <div class="group flex items-start py-2">
        <a use:inertia href="/pegawai">
          <div class={isUrl('pegawai') ? 'text-white' : 'text-indigo-300 group-hover:text-white'}>Manajemen Pegawai</div>
        </a>
      </div>
    {/if}
  </div>
